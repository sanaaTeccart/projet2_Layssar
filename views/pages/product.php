      ...
      <div class="row g-5 mb-5 mb-lg-8" data-product-details="data-product-details">
        <div class="col-12 col-lg-6">
          <div class="row g-3 mb-3">
            <img class="img-fluid mb-5 rounded-3" src="../images/<?php echo $pageData['product']['url_img']; ?> " alt="image introuvable" />
        ...
        <div class="col-12 col-lg-6">
          <div class="d-flex flex-column justify-content-between h-100">
            <div>
              ...
              <div>
                <h3 class="mb-3 lh-sm"><?php echo $pageData['product']['name']; ?></h3>
                <!-- <div class="d-flex flex-wrap align-items-center"> -->

                <h1 class="me-3"><?php echo $pageData['product']['price']; ?>CAD</h1>
              </div>
              <p class="text-success fw-semi-bold fs-1 mb-2"> <?php echo $pageData['product']['qtty']; ?>en stock</p>
            </div>
            <br>
        ...
        <div class="col-12 col-lg-7 col-xl-8">
          <div class="tab-content" id="productTabContent">
            <div class="tab-pane pe-lg-6 pe-xl-12 fade show active text-1100" id="tab-description" role="tabpanel" aria-labelledby="description-tab">
              <p class="mb-5"><?php echo $pageData['product']['description']; ?></p>
            </div>
